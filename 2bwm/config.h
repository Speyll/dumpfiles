 ...
 *6)emptycol         */
static const char *colors[] = {"#88C0D0","#455173","#A3BE8C","#EBCB8B","#7D97BB","#262b35","#000000"};
...
static const uint8_t borders[] = {4,7,4,4};
...
static key keys[] = {
    ...
    // Top right:
    {  MOD ,              XK_o,          teleport,          {.i=TWOBWM_TELEPORT_TOP_RIGHT}},
    // Bottom left:
    {  MOD ,              XK_v,          teleport,          {.i=TWOBWM_TELEPORT_BOTTOM_LEFT}},
    // Bottom right:
    ...
    // vertically right
    {  MOD |SHIFT,        XK_o,          maxhalf,           {.i=TWOBWM_MAXHALF_VERTICAL_RIGHT}},
    // horizontally left
    {  MOD |SHIFT,        XK_v,          maxhalf,           {.i=TWOBWM_MAXHALF_HORIZONTAL_BOTTOM}},
    // horizontally right
    ...
    {  MOD |SHIFT|CONTROL,XK_o,          maxhalf,           {.i=TWOBWM_MAXHALF_FOLD_HORIZONTAL}},
    //unfold vertically
    {  MOD |SHIFT|CONTROL,XK_v,          maxhalf,           {.i=TWOBWM_MAXHALF_UNFOLD_VERTICAL}},
    //unfold horizontally
    ...
    {  MOD,               XK_f,          fix,               {}},
    // Move the cursor
    {  MOD ,              XK_k,          cursor_move,       {.i=TWOBWM_CURSOR_UP_SLOW}},
    {  MOD ,              XK_j,          cursor_move,       {.i=TWOBWM_CURSOR_DOWN_SLOW}},
    {  MOD ,              XK_l,          cursor_move,       {.i=TWOBWM_CURSOR_RIGHT_SLOW}},
    {  MOD ,              XK_h,          cursor_move,       {.i=TWOBWM_CURSOR_LEFT_SLOW}},

    // Move the cursor faster
    {  MOD |SHIFT,        XK_k,          cursor_move,       {.i=TWOBWM_CURSOR_UP}},
    {  MOD |SHIFT,        XK_j,          cursor_move,       {.i=TWOBWM_CURSOR_DOWN}},
    {  MOD |SHIFT,        XK_l,          cursor_move,       {.i=TWOBWM_CURSOR_RIGHT}},
    {  MOD |SHIFT,        XK_h,          cursor_move,       {.i=TWOBWM_CURSOR_LEFT}},
